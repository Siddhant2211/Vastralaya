  ...
  return (
    <div className="">
      <Container className="max-w-6xl lg:px-8 py-12">
        <h1 className="text-3xl font-bold mb-6">About Vastralaya</h1>
        <p className="mb-4">
          Vastralaya is a cutting-edge technology company dedicated to providing
        ...
        <p>
          At Vastralaya, we believe in the power of technology to transform

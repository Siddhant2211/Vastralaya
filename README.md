...
Select your "Vastralaya ecommerce" project.
...
NEXT_PUBLIC_BASE_URL: Set to http://localhost:3000 for local development. Update to your live domain (e.g., https://Vastralaya.reactbd.com/) when deploying.
